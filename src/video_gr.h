...
/**
 * @brief Display initial graphics state.
 * @return 0 if success.
 * */
int vg_start();
...
/**
 * @briefDisplay game graphics state.
 * @return 0 if success.
 * */
int vg_game();
...
/**
 * @brief Display box around selected menu option.
...
/**
 * @brief Set the given pixel with the given color.
 * @param x coordinate.
 * @param y coordinate.
 * @param color.
 * */
...
/**
 * @brief Display the given pixmap.
 * @param x coordinate.
 * @param y coordinate.
 * @param pixmap.
 * @param width.
...
/**
 * @brief Copy double buffer to vram.
 * */
void vg_display();
